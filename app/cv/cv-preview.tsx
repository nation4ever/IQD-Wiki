...
.cp-contact-links { margin-top: 3px; display: flex; flex-direction: column; align-items: flex-end; gap: 1px; }
          ...
          <div className="cp-header-top">
            ...
            <div className="cp-contact">
              ...
              <div className="cp-contact-links">
                {cv.links.map((lnk) => (
                  <PreviewLink key={lnk.id} link={lnk} accentColor={accentColor} />
                ))}
              </div>
            </div>
          </div>
